...
const Footer = () => {
  return (
    <footer className="w-full max-w-screen-2xl bg-white">
      <div className="mb-20 max-w-screen-2xl md:mb-0 px-5">
        <div className="sm:flex-between grid grid-cols-2 gap-10 py-10 sm:gap-0">
          <div className="sm:mx-auto">
            <h4 className="mb-7 text-lg font-medium text-gray-900">Waver UI</h4>
            <ul className="text-sm transition-all duration-500">
              <li className="mb-6">
                <Link
                  href={{ pathname: "/", query: { content: "houseContent" } }}
              ...
              <li className="mb-6">
                <Link
                  href={{
                    pathname: "/",
                    query: { content: "apartmentContent" },
                  }}
                  className=" text-gray-600 hover:text-gray-900"
                >
                  Apartments
              ...
              <li className="mb-6">
                <Link
                  href={{ pathname: "/", query: { content: "plotsContent" } }}
                  className=" text-gray-600 hover:text-gray-900"
                >
                  Plots & Lands
                </Link>
              ...
              <li>
                <Link
                  href={{ pathname: "/", query: { content: "pgContent" } }}
                  className=" text-gray-600 hover:text-gray-900"
                >
                  PG / Co-living
                </Link>
        ...
        <div className="border-t border-gray-200 py-7">
          <div className="flex flex-col items-center justify-center lg:flex-row lg:justify-between">
            <span className="text-sm text-gray-500 sm:mx-auto">
              ©<a href="https://www.parvez.me/">Waver UI</a> 2024, All rights
              reserved.
            </span>
            <div className="mt-4 flex space-x-4 sm:justify-center sm:mx-auto lg:mt-0 ">
              <a
                href="javascript:;"
              ...
              >
                <svg
                  className="h-[1.125rem] w-5 text-white"
                  viewBox="0 0 15 15"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
