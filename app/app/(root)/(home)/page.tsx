...
export default function Home() {
  return (
    <main className="container-2xl mt-8">
      <div className="flex-center flex-col space-y-5 sm:space-y-6 lg:space-y-8">
        <div className="px-4 py-1.5 border border-slate-100 dark:border-gray-800 rounded-full shadow-sm bg-slate-100 dark:bg-gray-800 flex-center gap-2">
        ...
        <div className="flex-col space-y-3.5 items-center justify-center max-w-[400px] w-full xs:w-auto xs:space-y-0 xs:flex-center xs:flex-row gap-4 md:gap-5">
          <button className="px-4 py-[9px] lg:py-[12px] dark:bg-white dark:text-black bg-gray-800 text-white max-w-[400px] w-full xs:w-auto rounded-[8px] body-regular">
            Get Started
          </button>
          <button className="px-4 py-[9px] lg:py-[12px] border border-slate-300 text-gray-900 rounded-[8px] body-regular w-full max-w-[400px] xs:w-auto dark:text-white flex-center gap-2">
            <Star size={20} />
            Explore Components
          </button>
        </div>
